...
namespace _12306
{
    ...
    public class HttpWebRequestExtension
    {
        ...
        /// <summary> /// 提交订单数据 /// </summary> /// <param name="url"></param> /// <param name="cookie"></param> /// <param name="param"></param> /// <returns></returns> 
        ...
        /// <summary> /// 获取页面数据 /// </summary> /// <param name="url"></param> /// <param name="cookie"></param> /// <returns></returns> 
        ...
        /// <summary> /// 获取网页验证码图片 /// </summary> /// <param name="url"></param> /// <param name="cookie"></param> /// <returns></returns> 
        public static object GetWebImage(string url, CookieContainer cookie)
        {
            ...
            request.UseDefaultCredentials = true; // request.Proxy = null;
